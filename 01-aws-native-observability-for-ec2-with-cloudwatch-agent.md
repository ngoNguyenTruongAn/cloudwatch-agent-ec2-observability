...
Full config được lưu trong repo tại: [Case 1 - File Agent Config](./scripts/case1-cloudwatch-agent-config.json)
...
User Data script được lưu trong repo tại: [Case 2 - User Data](./scripts/case2-user-data.sh)
